...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[Bio-Inspired Distributed Sensing]{\Large Aerodynamic Variables and Loads
	Estimation Using Bio-Inspired Distributed Sensing}
%\subtitle{Subtitle}
\author{\large \emph{Sergio A. Araujo-Estrada}\inst{1} \and Shane Windsor \inst{2}}
\institute{\small\inst{1} Research Associate \\
  \inst{2} Lecturer in Aerodynamics\\
  ...
  \begin{columns}
    \begin{column}{0.4\textwidth}
      ...
      \begin{itemize}
        ...
        \item<6->{MCU-based data acquisition system using, sampling \@ \SI{200}{\hertz}}
  ...
  \vspace{-1.5em}
	\begin{columns}
	  \begin{column}{0.6\textwidth}
		  \begin{figure}[!htb]
        \centering
				\input{./Figures/ANN_AeroEst_BlockDiagram}
  ...
  \vspace{-2.0em}
	\begin{columns}
	  \begin{column}{0.49\textwidth}
		  \begin{figure}[!htb]
        \centering
				\input{./Figures/AoAAirspeedANNEstimation_TimeHist}
				\vspace{-1.25em}
    ...
    \begin{column}{0.49\textwidth}
		  \begin{figure}[!htb]
        \centering
				\input{./Figures/DragLiftPitchMomentANNEstimation_TimeHist}
				\vspace{-1.25em}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
\section[Previous Research]{Appendix: Previous Research}
